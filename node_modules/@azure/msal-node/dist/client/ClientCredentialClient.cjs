/*! @azure/msal-node v2.1.0 2023-09-05 */
'use strict';
'use strict';
...
class ClientCredentialClient extends msalCommon.BaseClient {
    ...
    async acquireToken(request) {
        ...
        if (cachedAuthenticationResult) {
            ...
            if (this.lastCacheOutcome ===
                msalCommon.CacheOutcome.REFRESH_CACHED_ACCESS_TOKEN) {
            ...
            this.lastCacheOutcome = msalCommon.CacheOutcome.NO_CACHE_HIT;
    ...
    async getCachedAuthenticationResult(request) {
        ...
        if (!cachedAccessToken) {
            this.lastCacheOutcome = msalCommon.CacheOutcome.NO_CACHED_ACCESS_TOKEN;
        ...
        if (msalCommon.TimeUtils.isTokenExpired(cachedAccessToken.expiresOn, this.config.systemOptions.tokenRenewalOffsetSeconds)) {
            this.lastCacheOutcome = msalCommon.CacheOutcome.CACHED_ACCESS_TOKEN_EXPIRED;
        ...
        if (cachedAccessToken.refreshOn &&
            ...
            this.lastCacheOutcome = msalCommon.CacheOutcome.REFRESH_CACHED_ACCESS_TOKEN;
            this.serverTelemetryManager?.setCacheOutcome(msalCommon.CacheOutcome.REFRESH_CACHED_ACCESS_TOKEN);
        }
